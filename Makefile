...
# If using the older audio micro code,
...
SRC_DIRS += src src/buffers src/main/assets/models src/main sound asm src/main/leveldata/a30
...
INCLUDE_DIRS += /usr/include/n64 /usr/include/n64/PR /usr/include/n64/nusys include $(BUILD_DIR) $(BUILD_DIR)/include src sound .
...
$(BUILD_DIR)/$(LD_SCRIPT): $(LD_SCRIPT)
	...
	$(V)$(CPP) $(CPPFLAGS) -DBUILD_DIR=$(BUILD_DIR) -DN_AUDIO=$(N_AUDIO) -MMD -MP -MT $@ -MF $@.d -o $@ $<
